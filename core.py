...
def detect_faces(faces_queue, console_status_queue, exit_flag):
    ...
    def update_console_status():
        ...
        """
        nonlocal status_code, student_img, student_id, first_name, last_name, course, year

        while not exit_flag.value:
            try:
                status, student_id, name, course, year, student_img = console_status_queue.get(
                    timeout=0.1
                )
...
def cache_database(database):
    ...
    return known_face_ids, known_face_names, known_face_course, known_face_year, known_student_imgs, known_face_encodings
    ...
    while True:
        ...
        for face_encoding in face_encodings:
            ...
            if matches[best_match_index]:
                ...
                course = known_face_course[best_match_index]
                year = known_face_year[best_match_index]
                ...
                console_status_queue.put((status, str(student_id), name, course, year, student_img))
