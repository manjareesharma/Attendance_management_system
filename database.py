...
class Database:
    def __init__(self, db):
        ...
        self.cur.execute(
            "CREATE TABLE IF NOT EXISTS student (id TEXT PRIMARY KEY, name TEXT,course TEXT,year TEXT ,image BLOB, face_encoding BLOB);"
        )
        self.conn.commit()
    ...
    def fetch_id_and_name(self):
        ...
        """
        self.cur.execute("SELECT id, name, course, year FROM student;")
        return self.cur.fetchall()

    def insert(self, id, name, course, year, image, face_encoding):
        """
        ...
        self.cur.execute(
            ...
            (id, name, course, year,image, face_encoding),
        )
        self.conn.commit()
